...
-   The Turkish-specific data was obtained from Kaggle, specifically from the [Turkish Movies Dataset](https://www.kaggle.com/datasets/emreokcular/turkish-movies) shared by Emre OkC'ular.
...
load("path/to/movies.RData")
# 1. Global movies verisini y??kle
load("movies.RData")

# 2. Turkish movies verisini oku
turkish_movies <- read.csv("final_dataset.csv", fileEncoding = "UTF-8")

# 3. Turkish movies verisini geni??let
